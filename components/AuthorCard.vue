  ...
  <div class="md:fixed">
    <div class="md:block flex justify-center items-center">
      <nuxt-img
        ...
        loading="lazy"
        alt="me"
        class="logo shadow-2xl md:h-60 md:w-60 h-40 w-40 rounded-full"
      />
      <div class="mb-2 mx-7 mt-4 justify-center items-center">
        <h1
          class="logo md:text-3xl text-2xl text-gray-800 font-bold dark:text-blue-100"
        >
           {{ siteMetadata.author }}
        </h1>
        <div class="logo md:text-lg text-gray-600 dark:text-blue-100">
           {{ siteMetadata.position }}
        </div>
        <a
          :href="`mailto:${siteMetadata.email}`"
          class="logo text-gray-600 md:hidden mt-1 dark:text-blue-100"
        >
           {{ siteMetadata.email }}
        </a>
      </div>
    ...
    <div class="mx-7 hidden md:block">
      <div class="logo my-2 text-gray-600 flex dark:text-blue-100">
        <Mail />
      ...
      <div class="logo my-2 text-gray-600 flex dark:text-blue-200">
        <Github />
